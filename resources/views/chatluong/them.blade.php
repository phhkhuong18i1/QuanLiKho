          ...
          <div class="col-lg-12">
            <section class="panel">
              ...
              @if (count($errors) > 0)
                    ...
                    @endif
                <div class="form">
                  <form class="form-validate form-horizontal " id="register_form" method="POST" action="qlkho/chatluong/them">
                  @csrf
                    <div class="form-group ">
                      <label  class="control-label col-lg-2">Mã chất lượng <span class="required">*</span></label>
                      <div class="col-lg-10">
                      <input class="form-control" name="txtMa"/>
                      </div>
                    </div>
                    <div class="form-group ">
                      <label  class="control-label col-lg-2">Tên chất lượng <span class="required">*</span></label>
                      <div class="col-lg-10">
