...
<body>
    ...
    <center><h3> Kho: {{$khovt->kho_ten}} | Số lượng tồn: {{$tongsl}}</h3> </center>
            ...
            <?php $count = 0; ?>
                @foreach ($vattukho as $value)
                    <tr>
                        ...
                        <td style="border:thin blue solid;border-style:dashed;" >{{ number_format($value->giatien*$value->soluong_ton) }}</td>
                      
                    </tr>
                @endforeach
                <tr><td colspan="6" align="right">Tổng tiền: {!! number_format($tongtien[0]->thanhtien)  !!} vnđ</td></tr>
        </tbody>
    </table>
    ...
    <table style="margin-bottom:-300px;">
        ...
        <tr>
            ...
            <td align="right" class="writer-name"><span>(Ký và ghi rõ họ tên)</span></td>
        </tr>
