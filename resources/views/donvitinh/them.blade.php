          ...
          <div class="col-lg-12">
            <section class="panel">
              ...
              @if (count($errors) > 0)
                    ...
                    @endif
                <div class="form">
                  <form class="form-validate form-horizontal " id="register_form" method="POST" action="qlkho/donvitinh/them">
                  @csrf
                    ...
                    <div class="form-group ">
                      <label  class="control-label col-lg-2">Tên đơn vị tính <span class="required">*</span></label>
                      <div class="col-lg-10">
                    ...
                    <div class="form-group">
                      <div class="col-lg-offset-2 col-lg-10">
                        ...
                        <a class="btn btn-warning" href="qlkho/donvitinh/danhsach">Hủy</a>
                      </div>
                    </div>
                  </form>
                </div>
