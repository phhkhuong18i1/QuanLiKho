          ...
          <div class="col-lg-12">
            <section class="panel">
              ...
              @if (count($errors) > 0)
                    ...
                    @endif
                <div class="form">
                  <form class="form-validate form-horizontal " id="register_form" method="POST" action="qlkho/khuvuc/them">
                  @csrf
                    <div class="form-group ">
                      <label  class="control-label col-lg-2">Mã khu vực <span class="required">*</span></label>
                      <div class="col-lg-10">
