...
<section id="main-content">
    ...
    <hr>
    <p ><center style="font-size:30px; ">PHIẾU NHẬP KHO</center></p>
    <table>
      <tr>
      ...
      <tr>
        <td width="150px"><strong>Lý do nhập:</strong></td> <td>{!!$pnk->lydo!!}</td>
        <td></td>
      </tr>
      <tr>
        <td width="150px"><strong>Nhập từ:</strong></td> <td>{!!$npp->npp_ten!!}</td>
        <td></td>
      </tr>
    </table><br><br>
    ...
    <table class="sumary-table">
      <tr>
        ...
        <td width="335px" align="right">{!! number_format($pnk->tongtien) !!} vnđ</td>
      </tr>
    </table><br>
    <div >
    <center style="font-size:20px"><a  class="btn btn-primary"  target='_blank' href='qlkho/nhapkho/innhapkho/{{$pnk->id}}'>In</a>
    <a href="qlkho/nhapkho/nhap" class="btn btn-warning" >Hủy</a> </center>
    </div>
    </div>
    </section>
    </section>
