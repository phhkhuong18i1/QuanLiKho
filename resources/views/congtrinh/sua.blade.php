          ...
          <div class="col-lg-12">
            <section class="panel">
              ...
              @if (count($errors) > 0)
                    ...
                    @endif
                <div class="form">
                  <form class="form-validate form-horizontal " id="register_form" method="POST" action="qlkho/congtrinh/sua/{{ $congtrinh->id }}">
                  @csrf
                    <div class="form-group ">
                      <label   class="control-label col-lg-2">Tên công trình <span class="required">*</span></label>
                      <div class="col-lg-10">
                      <input class="form-control" name="txtTen" value="{{ $congtrinh->ten }}"/>
                      </div>
                    </div>
                    <div class="form-group ">
                      <label   class="control-label col-lg-2">Địa chỉ <span class="required">*</span></label>
                      <div class="col-lg-10">
                      <input class="form-control" name="txtDiaChi" value="{{ $congtrinh->diachi }}"/>
                      </div>
                    </div>
