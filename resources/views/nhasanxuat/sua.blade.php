        ...
        <div class="row">
          <div class="col-lg-12">
            <ol class="breadcrumb">
              ...
              <li><i class="fa fa-pencil fa-fw"></i>Sửa</li>
            </ol>
          </div>
        </div>
        <!-- Form validations -->
          ...
          <div class="col-lg-12">
            <section class="panel">
              ...
              @if (count($errors) > 0)
                    ...
                    @endif
                <div class="form">
                  <form class="form-validate form-horizontal " id="register_form" method="POST" action="qlkho/nhasanxuat/sua/{{ $nsx->id }}">
                  @csrf
                    <div class="form-group ">
                      <label   class="control-label col-lg-2">Mã nhà sản xuất <span class="required">*</span></label>
                      <div class="col-lg-10">
                        <input class=" form-control" id="fullname" name="txtMa" value="{{ $nsx->nsx_ma }}" type="text" />
                      </div>
                    </div>
                    <div class="form-group ">
                      <label   class="control-label col-lg-2">Tên nhà sản xuất <span class="required">*</span></label>
                      <div class="col-lg-10">
                        <input class=" form-control" id="address" name="txtTen" value="{{ $nsx->nsx_ten }}" type="text" />
                      </div>
                    </div>
                    <div class="form-group ">
