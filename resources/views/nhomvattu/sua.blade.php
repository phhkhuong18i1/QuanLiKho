          ...
          <div class="col-lg-12">
            <section class="panel">
              ...
              @if (count($errors) > 0)
                    ...
                    @endif
                <div class="form">
                  <form class="form-validate form-horizontal " id="register_form" method="POST" action="qlkho/nhomvattu/sua/{{ $nhomvattu->id }}">
                  @csrf
                    <div class="form-group ">
                      <label   class="control-label col-lg-2">Mã <span class="required">*</span></label>
                      <div class="col-lg-10">
                        <input class=" form-control" id="fullname" name="txtMa" value="{{ $nhomvattu->nvt_ma }}" type="text" />
                      </div>
                    </div>
                    <div class="form-group ">
                      <label   class="control-label col-lg-2">Tên <span class="required">*</span></label>
                      <div class="col-lg-10">
                        <input class=" form-control" id="address" name="txtTen" value="{{ $nhomvattu->nvt_ten }}" type="text" />
                      </div>
                    </div>
